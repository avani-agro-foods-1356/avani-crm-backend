...
const resourceName: string = 'knowledge';

@Injectable()
export class KnowledgeService {
  private readonly filePath = path.join(process.cwd(), 'knowledge.json');
  ...
  findAll() {
    try {
      ...
      console.error('Error reading knowledge data', e);
      return [];
    }
  }
  ...
  create(item: any) {
    try {
      ...
      console.error('Error writing knowledge data', e);
      throw e;
    }
  }

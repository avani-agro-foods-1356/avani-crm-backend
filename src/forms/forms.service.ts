...
const resourceName: string = 'forms';

@Injectable()
export class FormsService {
  private readonly filePath = path.join(process.cwd(), 'forms.json');
  ...
  findAll() {
    try {
      ...
      console.error('Error reading forms data', e);
      return [];
    }
  }
  ...
  create(item: any) {
    try {
      ...
      console.error('Error writing forms data', e);
      throw e;
    }
  }
  ...
  remove(id: string) {
    try {
      ...
      console.error('Error deleting forms item', e);
